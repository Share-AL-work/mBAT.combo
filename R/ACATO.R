...
#'
#' combine the test results of mBAT and fastBAT
#' by the aggregated Cauchy combination method (ACAT)
#'
#' @param p: integrated in function of mBAT_SVD.R
#' using P-value of mBAT and fastBAT
#'
